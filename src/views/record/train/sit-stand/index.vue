 ...
 * @LastEditTime: 2022-09-14 14:52:03
 * @Description : 坐站训练-数据记录
-->
<template>
  <div class="sit-stand">
    <!-- 顶部 -->
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      this.loading = true
      db.train_data
        .where(['userId', 'trainType', 'pdfTime'])
        .between(
          [
    ...
    handlePrint(index, row) {
      this.$router.push({
        ...
        query: {
          ...
          routerName: JSON.stringify('/train-record/sit-stand')
        }
      })
    },

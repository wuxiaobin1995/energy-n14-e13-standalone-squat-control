 ...
 * @LastEditTime: 2024-11-28 09:56:16
 * @Description : 精准负重训练-数据记录
-->
<template>
  <div class="accurate-load">
    <!-- 顶部 -->
    ...
    handlePrint(index, row) {
      this.$router.push({
        ...
        query: {
          ...
          routerName: JSON.stringify('/train-record/accurate-load')
        }
      })
    },

 ...
 * @LastEditTime: 2022-09-14 14:51:39
 * @Description : 站立稳定测试-数据记录
-->
<template>
  <div class="standing-stability">
    <!-- 顶部 -->
    ...
    >
      ...
      <el-table-column
        ...
        sortable
      />
      <el-table-column label="平均重量分布百分比" align="center">
        <el-table-column
          align="center"
          prop="leftAverageWeightPercent"
          label="左"
          width="100"
        />
        <el-table-column
          align="center"
          prop="rightAverageWeightPercent"
          label="右"
          width="100"
        />
      </el-table-column>
    ...
    handlePrint(index, row) {
      this.$router.push({
        ...
        query: {
          ...
          routerName: JSON.stringify('/test-record/standing-stability')
        }
      })
    },

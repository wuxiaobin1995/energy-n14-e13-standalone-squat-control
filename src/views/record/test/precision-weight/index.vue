 ...
 * @LastEditTime: 2022-09-14 14:51:16
 * @Description : 精准负重测试-数据记录
-->
<template>
  <div class="precision-weight">
    <!-- 顶部 -->
...
export default {
  ...
  methods: {
    ...
    handlePrint(index, row) {
      this.$router.push({
        ...
        query: {
          ...
          routerName: JSON.stringify('/test-record/precision-weight')
        }
      })
    },
    ...
    handleTendencyPrint() {
      ...
      //   query: {
      //     userId: this.$store.state.currentUserInfo.userId,
      //     router: 'test-record/precision-weight',
      //     type: '精准负重测试'
      //   }
      // })
    },

 ...
 * @LastEditTime: 2022-09-14 14:51:26
 * @Description : 静蹲测试-数据记录
-->
<template>
  <div class="quiet-squat-down">
    <!-- 顶部 -->
    ...
    handlePrint(index, row) {
      this.$router.push({
        ...
        query: {
          ...
          routerName: JSON.stringify('/test-record/quiet-squat-down')
        }
      })
    },

      ...
      if (this.$store.state.currentUserInfo.affectedSide === '右') {
        this.colorObj = {
          'background-image': `linear-gradient(
            to right,
            rgba(255, 255, 0, 0.5),
            rgba(255, 255, 0, 0.5) ${this.target - 2.5}%,
            rgba(0, 128, 0, 0.5) ${this.target - 2.5}%,
            rgba(0, 128, 0, 0.5) ${this.target + 2.5}%,
            rgba(255, 255, 0, 0.5) ${this.target + 2.5}%,
            rgba(255, 255, 0, 0.5) 100%
          )`
        ...
        this.colorObj = {
          'background-image': `linear-gradient(
            to right,
            rgba(255, 255, 0, 0.5),
            rgba(255, 255, 0, 0.5) ${100 - this.target - 2.5}%,
            rgba(0, 128, 0, 0.5) ${100 - this.target - 2.5}%,
            rgba(0, 128, 0, 0.5) ${100 - this.target + 2.5}%,
            rgba(255, 255, 0, 0.5) ${100 - this.target + 2.5}%,
            rgba(255, 255, 0, 0.5) 100%
          )`

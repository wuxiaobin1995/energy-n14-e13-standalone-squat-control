 ...
 * @LastEditTime: 2022-09-14 15:18:53
 * @Description : 站立平衡测试-参数设置
-->
<template>
  <div class="standing-balance-set">
    <!-- 语音播放 -->
...
export default {
  ...
  data() {
    return {
      ...
      audioSrc: path.join(__static, `narrate/mandarin/3-站立平衡测试.mp3`),

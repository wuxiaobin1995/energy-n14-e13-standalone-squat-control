<!--
 * @Author      : Mr.bin
 * @Date        : 2022-08-15 11:07:50
 * @LastEditTime: 2022-08-15 11:28:03
 * @Description : 动态下蹲测试-具体测量
-->
<template>
  <div class="dynamic-squat-measure">
    <div class="wrapper">
      <el-page-header
        class="page"
        title="返回上一页"
    ...
    handlePrint() {
      this.$router.push({
        ...
        query: {
          ...
          routerName: JSON.stringify('/test-select/dynamic-squat-set')
        }
      })
    }
  }

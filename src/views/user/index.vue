 ...
 * @LastEditTime: 2023-06-22 17:22:45
 * @Description : 用户
-->
<template>
  <div class="user">
        ...
        <el-table-column type="expand">
          <template slot-scope="props">
            <el-form label-position="left" inline class="table-expand">
              ...
              <el-form-item label="患侧极限负重(kg)：">
                <span>{{ props.row.ultimateLoad }}</span>
              </el-form-item>
